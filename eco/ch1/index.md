---
title: 🏢 Firmes, gouvernances et et organisation
---

# Introduction

## Premier éléments de définitions

Tout d'abord, **qu'es ce qu'une firme ?** C'est une unité économique qui possède un **statut juridique** qui offre **autonomie *légale***. Elle utilise des **facteurs de productions** pour **produire** des **biens et services** sur **un marché**.

*En France, l'État, les associations, les sociétés sociales et solidaires, les ONG font partie du système de production sans pour autant être des entreprises.* On les apelles **ISBLSM** (Institution Sans But Lucratif au Services des Ménages). Les entreprises sont des cas particuliers des organisations productives.

> [!abstract] 🇬🇧 En Anglais
> Une entreprise en anglais donne **firm**, *company* ou encore *entreprise*.

Deux grand points :
1. Les entreprises s'engagent dans la **production marchande**. Les entreprises qui ne cherchent pas à faire du profis se comportent de la même manière que celles qui ne le cherche pas. Selon Friedman, c'est un objectif stratégique essentiel des entreprises (*même sans but lucratif, il faut faire survivre l'entrerise*). La différence réside dans la recherche de **maximisation** du profit.. La différen
2. Les entreprises sont des **unité de décision autonomes**. Il existe des entreprises ou la propriété et la gestion de l'entreprise sont séparés. Plus elles sont séparés, plus elles sont flous. Les **filiales** sont aussi moins autonomes.

Les entreprises sont classés de différentes manières selon les pays :
...
L'entrepreneur innovateur est un concept créé par Joseph Schumpter en 1911. C'est un idéal type. C'est quelqu'un qui a le gout, qui vie pour l’innovation. *L'entrepreneur Innovateur/Schumpeterien est un élément perturbateur, de nature avantureuse, qui aime le risque.* C'est pour lui une question de personalitée.
...
> [!INFO] Document 2 : Les coûts de transaction
